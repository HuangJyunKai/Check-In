        ...
        if(w>face_size[0] and h>face_size[1]):
            ...
            if status != prediction :
                ...
                if bossName in namePredict :
                    ...
                    print('Prediction :',prediction,'[',namePredict,']','Time :',office_time)
                ...
                elif namePredict == 'safe':
                    putText(img, namePredict, x, y-20, (0,255,255), thickness=2, size=2)
                    print('Prediction :',prediction,'[',namePredict,']')
                    DAN.push('HKA_STAFF_NUM',prediction)                
                    DAN.push('HKA_STRING',office_time)
                    time.sleep(1.5)
